...
#PPA_piper="deb http://ppa.launchpad.net/libratbag-piper/piper-libratbag-git/ubuntu bionic main"
...
#PPA_drivers="deb http://ppa.launchpad.net/graphics-drivers/ppa/ubuntu bionic main"
...
#sudo apt-add-repository "$PPA_drivers" -y
wget -nc "$URL_WINE_KEY"
sudo apt-key add winehq.key
sudo apt-add-repository "deb $URL_PPA_WINE bionic main"
#sudo apt-add-repository"$PPA_lqx" -y
#sudo apt-add-repository "$PPA_piper" -y
#sudo apt-add-repository "$PPA_pkppa" -y
